...
data = xlsread('Stock_data.xlsx','data','B17:F28')
[~,names] = xlsread('Stock_data.xlsx','data','B16:F16')
C = cov(data) 
R = mean(data) 
...
portfolioexamples_plot('Efficient Frontier with Capital Allocation Line', ...
    ...
    [mret, cret, eret, retshpr_fully , retshpr_diret, retshpr_iter], ...
    {'Market', 'Cash', 'Equal','Sharpe fully invest', 'Sharpe diret','Sharpe iter'}}, ...
